...
import { servicesApi, ServiceCreate } from '../lib/services'
...
export default function ServiceOnboarding() {
  ...
  // Fetch departments and business units from master data
  ...
  const handleNext = () => {
    if (currentStep === 1) {
      if (!formData.name || !formData.service_type || !formData.vendor_id) {
  ...
  const updateField = (field: keyof ServiceCreate, value: any) => {
    setFormData(prev => ({ ...prev, [field]: value }))
  }

  const steps = [
    { number: 1, title: 'Basic Information', description: 'Service name and type' },
    { number: 2, title: 'Business Information', description: 'Owner, department, and business details' },
    { number: 3, title: 'Additional Details', description: 'Service details and support info' },
    ...
    <Layout user={user}>
      <PageContainer maxWidth="full">
        <PageHeader
          ...
          subtitle="Add a new service for qualification and assessment"
          backButton={true}
          backUrl="/onboarding"
        />
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      const metadata = formData.metadata || {}
                      updateField('metadata', { ...metadata, department: e.target.value || null })
                    }}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      const metadata = formData.metadata || {}
                      updateField('metadata', { ...metadata, business_unit: e.target.value || null })
                    }}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                  >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    const metadata = formData.metadata || {}
                    updateField('metadata', { ...metadata, support_email: e.target.value || null })
                  }}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    const metadata = formData.metadata || {}
                    updateField('metadata', { ...metadata, support_phone: e.target.value || null })
                  }}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    const metadata = formData.metadata || {}
                    updateField('metadata', { ...metadata, support_docs_url: e.target.value || null })
                  }}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
            ...
            <div className="space-y-6">
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                <p className="text-sm text-purple-800">
                  Review your service information. After submission, a qualification workflow will be automatically triggered if a matching workflow is found.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900">{formData.service_level || '-'}</p>
                  </div>
                  <div>
                    ...
                    <div>
                      ...
                      <p className="text-gray-900">
                        {(formData.metadata as any)?.support_docs_url ? (
                          <a href={(formData.metadata as any).support_docs_url} target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:underline">
                            {(formData.metadata as any).support_docs_url}
                          </a>
                        ) : '-'}
                      </p>
