    ...
    <Layout user={user}>
      <div className="space-y-6">
        ...
        <div className="dashboard-header">
          <div className="flex items-center justify-between mb-6">
            ...
            <select
              ...
              className="compact-input w-40 font-medium shadow-md hover:shadow-lg transition-shadow"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          >
            <div className="metric-card-gradient"></div>
            <div className="relative z-10">
              <div className="metric-icon bg-gradient-to-br from-blue-500 to-blue-600 text-white">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
              </div>
              <div className="metric-value text-blue-600 group-hover:text-blue-600 transition-colors">{stats?.total_agents || 0}</div>
          ...
          >
            <div className="metric-card-gradient"></div>
            <div className="relative z-10">
              <div className="metric-icon bg-gradient-to-br from-purple-500 to-purple-600 text-white">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <div className="metric-value text-purple-600 group-hover:text-purple-700 transition-colors">{stats?.total_reviews || 0}</div>
          ...
          >
            <div className="metric-card-gradient"></div>
            <div className="relative z-10">
              <div className="metric-icon bg-gradient-to-br from-green-500 to-green-600 text-white">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
              </div>
              <div className="metric-value text-green-600 group-hover:text-green-700 transition-colors">
          ...
          >
            <div className="metric-card-gradient"></div>
            <div className="relative z-10">
              <div className="metric-icon bg-gradient-to-br from-amber-500 to-amber-600 text-white">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                </svg>
              </div>
              <div className="metric-value text-amber-600 group-hover:text-amber-700 transition-colors">{typeData.length}</div>
              <div className="metric-label">Agent Types</div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <div className="chart-card">
            <div className="chart-card-header">
              <h3 className="chart-title">Agent Submissions Trend</h3>
            </div>
          ...
          <div className="chart-card">
            <div className="chart-card-header">
              <h3 className="chart-title">Review Activity Trend</h3>
            </div>
            <div className="chart-container-modern">
              <ResponsiveContainer width="100%" height={300}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          ...
          <div className="chart-card">
            <div className="chart-card-header">
              <h3 className="chart-title">Agents by Status</h3>
            </div>
            <div className="chart-container-modern">
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
            ...
            <p className="text-xs text-muted-foreground mt-2 text-center">Click on a segment to view agents</p>
          </div>

          {/* Reviews by Stage */}
          <div className="chart-card">
            <div className="chart-card-header">
              <h3 className="chart-title">Reviews by Stage</h3>
            </div>
            <div className="chart-container-modern">
              <ResponsiveContainer width="100%" height={300}>
            ...
            <p className="text-xs text-muted-foreground mt-2 text-center">Click on a bar to view reviews</p>
          </div>

          {/* Agents by Type */}
          <div className="chart-card">
            <div className="chart-card-header">
              <h3 className="chart-title">Agents by Type</h3>
            </div>
            <div className="chart-container-modern">
              <ResponsiveContainer width="100%" height={300}>
            ...
            <p className="text-xs text-muted-foreground mt-2 text-center">Click on a bar to view agents by type</p>
          </div>
        </div>
