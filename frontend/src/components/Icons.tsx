...
export const DashboardIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
...
export const CatalogIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const MarketplaceIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
  </svg>
)

export const PlusIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M12 4v16m8-8H4" />
  </svg>
)

export const DocumentIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const TicketIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const ShieldCheckIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const CogIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const UsersIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const BuildingIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const ArrowUpIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M7 16l-4-4m0 0l4-4m-4 4h18" />
  </svg>
)

export const ChartBarIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const ArrowDownIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M17 13l-5 5m0 0l-5-5m5 5V6" />
  </svg>
)

export const PlugIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M13 10V3L4 14h7v7l9-11h-7z" />
  </svg>
)

export const LinkIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const DocumentTextIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
  </svg>
)

export const ChatIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const LockIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const AIPostureIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
  </svg>
)

export const EcosystemMapIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const BookOpenIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
  </svg>
)

export const DatabaseIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4" />
  </svg>
)

export const HelpIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const EditIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const EyeIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
...
export const PencilIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
  </svg>
)

export const UserPlusIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
  </svg>
)

export const CheckIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M5 13l4 4L19 7" />
  </svg>
)

export const XIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M6 18L18 6M6 6l12 12" />
  </svg>
)

export const MailIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const PhoneIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const GlobeIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const InboxIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const ChevronRightIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M9 5l7 7-7 7" />
  </svg>
)

export const ChevronDownIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const XCircleIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const ClockIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
  </svg>
)

export const MessageSquareIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const Share2Icon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z" />
  </svg>
)

export const SparklesIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const FileTextIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
  </svg>
)

export const FilterIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const CalendarIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const TrendingUpIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
  </svg>
)

export const RefreshCwIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const SaveIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const AlertCircleIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const UserCheckIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const AlertTriangleIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const NetworkIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const MapIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
  </svg>
)

export const BarChart3Icon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
  </svg>
)

export const ExternalLinkIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const TrashIcon = ({ className = "w-5 h-5", size, strokeWidth = 1.5 }: IconProps) => (
  <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const iconMap: Record<string, React.ComponentType<IconProps>> = {
  ...
  'chat': ChatIcon,
  'lock': LockIcon,
  'ai-posture': AIPostureIcon,
  'ecosystem-map': EcosystemMapIcon,
  'help': HelpIcon,
  'edit': EditIcon,
