...
class RolePermissionService:
    ...
    DEFAULT_PERMISSIONS = {
        ...
        "menu": {
            ...
            "menu.request_types": ("Request Type Management", "Access to Request Type Management page"),
        },
    ...
    ROLE_DEFAULT_PERMISSIONS: Dict[str, Dict[str, list]] = {
        "platform_admin": {
            "menu": [
                ...
                "menu.tenants", "menu.workflows", "menu.workflow_management", "menu.workflow_templates", "menu.workflow_analytics", "menu.screen_designer", "menu.form_designer", "menu.workflow_config", "menu.request_types", "menu.master_data", "menu.platform_config",
        ...
        "tenant_admin": {
            "menu": [
                ...
                "menu.entity_fields_catalog", "menu.tenant_settings", "menu.workflows", "menu.workflow_management", "menu.workflow_templates", "menu.workflow_analytics", "menu.screen_designer", "menu.form_designer", "menu.workflow_config", "menu.request_types",
